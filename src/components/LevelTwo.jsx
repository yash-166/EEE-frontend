    ...
    (<div className="flex flex-col items-center  text-white">
      ...
      <div className="flex flex-row justify-around w-full">
            <div className="text-center flex">
              <h2 className="text-xl font-bold">Finish Time: </h2>
              <p className="text-lg ms-4">{finishTime || "--:--:--"}</p>
            </div>
            {(showStartMessage || isRunning) && 
             <div className="text-center flex ">
             <h2 className="text-xl font-bold">Timer:</h2>
             <p className="text-lg ms-3">{formatTime(elapsedTime)}</p>
           </div>
            }
     ...
     >
      ...
      {/* <div className="relative w-[800px] h-[495px] flex items-center justify-center  rounded-lg ">
       */}
       <div className={`relative w-[800px] ${selectedCard !== null ? "h-[410px]" : "h-[495px]"} flex items-center justify-center rounded-lg transition-all duration-500`}>
        {selectedCard === null ? (
          // Show all four cards with animations
          cards.map((card) => (
            <>
          ...
          // Animate selected card moving to center
          <div
            className={`absolute  w-48 h-57 flex items-center justify-center rounded-lg cursor-pointer
              }`}
      ...
      <button
        ...
        // className="cursor-pointer mb-5  py-3 px-8 bg-blue-900 hover:bg-blue-700 rounded text-white font-bold transition-transform duration-300 hover:scale-105"
        className={`mb-5  py-3 px-8 bg-blue-900 hover:bg-blue-700 rounded text-white font-bold ${
          isRunning ? "cursor-pointer hover:scale-105" : "cursor-not-allowed opacity-80"
        }`}
      >
        Completed
      </button>
